...
class Group(Base):
    ...
    creator = relationship("User", back_populates="created_group", foreign_keys=[creator_id])
    students = relationship("User", back_populates="group", foreign_keys="[User.group_id]", cascade="all, delete-orphan")
    applications = relationship("Application", back_populates="group_applications", cascade="all, delete-orphan")
...
class User(Base):
    ...
    created_group = relationship("Group", back_populates="creator", foreign_keys="[Group.creator_id]")
    group = relationship("Group", back_populates="students", foreign_keys="[User.group_id]")
    sent_application = relationship("Application", back_populates="sending", cascade="all, delete-orphan")
    duties = relationship("Duty", back_populates="attendant", cascade="all, delete-orphan")
